...
static PyObject *AmiPyPython_GenericPrinter(PyObject *pArgs,
...
static PyObject *AmiPyPython_Print(PyObject *, PyObject *pArgs) {
  return AmiPyPython_GenericPrinter(pArgs, AmiPrintStr);
}

static PyObject *AmiPyPython_Error(PyObject *, PyObject *pArgs) {
  return AmiPyPython_GenericPrinter(pArgs, AmiError);
}
...
static PyModuleDef cModPyDem = {PyModuleDef_HEAD_INIT, "AmiPy",
                                "AmiBroker plug-in python module", -1,
                                AmiPyMethods};
